...
# Results
# For linear kernel, failed to reject deg1(1) == deg2(1); 
# rejected deg1(1) == deg2(2, 3, 4, 5). 
# So 1 is different than 2,3,4,5. 
...
save_slug <- 'package/gp_kernlearn/code/output/gof_boxm_quadkern_deg2/'
